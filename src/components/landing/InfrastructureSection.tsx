...
import { Monitor, Cpu, Database, Network, Server, Wifi } from 'lucide-react';
  ...
  return (
    <section id="infrastructure" ref={sectionRef} className="section-container bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className={cn(
          'mb-12 p-6 rounded-2xl bg-secondary/50 border border-border transition-all duration-700 delay-100',
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        )}>
          <p className="text-muted-foreground text-center">
            <span className="font-semibold text-foreground">Note:</span> Actual lab images and 
            detailed specifications will be uploaded by the Department Administrator.
          </p>
        </div>
